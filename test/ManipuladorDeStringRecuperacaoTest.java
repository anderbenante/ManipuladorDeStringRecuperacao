...
public class ManipuladorDeStringRecuperacaoTest {
	...
	public void deveOrdenarFraseRatoRoeu() {
		String fraseOrdenNormal = ManipuladorDeString.ordenar("O rato roeu a roupa do rei de Roma");
		assertEquals("O a do de rei rato roeu Roma roupa", fraseOrdenNormal);
	}
